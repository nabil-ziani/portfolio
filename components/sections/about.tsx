            ...
            <div className="container">
                ...
                <div className="mt-20 flex flex-col gap-8">
                    ...
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3">
                        ...
                        bg-gradient-to-r from-indigo-400 to-sky-300 after:content-[''] after:absolute after:inset-0 after:outline after:outline-2
                        after:-outline-offset-2 after:rounded-full after:outline-gray-950/30">
                                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-400 to-sky-300 -z-20 animate-ping [animation-duration:2s]" />
                                <div className="absolute inset-0 rounded-full bg-gradient-to-r from-indigo-400 to-sky-300 -z-10" />
